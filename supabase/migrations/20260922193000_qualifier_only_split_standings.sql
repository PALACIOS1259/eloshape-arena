-- Keep the public Semi-Split standings as the qualifier-only seeding table.
-- Playoff results still award normal EloShape points, but they must not reshuffle
-- the seeds or replacement order that were earned during the four qualifiers.
